...
create_connection <- function() {
  tryCatch({
    conn <- dbConnect(SQLite(), "recipe_db.sqlite")
...
dbExecute(conn, "CREATE INDEX IF NOT EXISTS idx_email ON users(email);")
...
(id, name, category, difficulty, prep_time, cook_time, servings,
 ingredients, instructions, tags, image_path, created_at, user_id)
VALUES
(14,'Salad','Appetizer','Easy',5,0,2,'Mixed greens\nCucumber\nOlive oil',
 '1. Chop vegetables.\n2. Toss with olive oil.\n3. Serve immediately.',
 'Light, versatile, perfect starter!','Salad_20260106_170537.jpg','2026-01-06 00:20:00',1),

(15,'Soup','Appetizer','Medium',5,15,3,'Chicken\nCarrots\nBroth',
 '1. Boil chicken in broth.\n2. Add chopped carrots.\n3. Simmer until tender.',
 'Comforting, and immune booster!','Soup_20260106_170650.jpg','2026-01-06 00:25:00',1),

(16,'Tacos','Appetizer','Hard',10,10,2,'Tortilla\nGround beef\nCheese',
 '1. Cook beef.\n2. Fill tortilla with beef and cheese.\n3. Fold and serve.',
 'Savory, and easy to eat snack!','Tacos_20260106_170757.jpg','2026-01-06 00:30:00',1),

(17,'Skewers','Appetizer','Hard',5,15,2,'Chicken\nBell pepper\nSoy sauce',
 '1. Cube chicken and pepper.\n2. Marinate in soy sauce.\n3. Grill until cooked.',
 'A perfect grilled snack!','Skewers_20260106_170905.jpg','2026-01-06 00:35:00',1),

(18,'Toast','Appetizer','Easy',2,3,1,'Bread\nButter\nAvocado',
 '1. Toast bread.\n2. Spread butter.\n3. Top with avocado.',
 'Simple, quick, and satisfying!','Toast_20260106_170419.jpg','2026-01-06 00:40:00',1),

(19,'Fries','Snack','Easy',5,10,2,'Potatoes\nOil\nSalt',
 '1. Cut potatoes.\n2. Fry until golden.\n3. Season with salt.',
 'A classic comfort snack!','Fries_20260106_165225.jpg','2026-01-06 00:45:00',1),

(20,'Nuggets','Snack','Easy',5,10,2,'Chicken\nBreadcrumbs\nEgg',
 '1. Dip chicken in egg, coat in breadcrumbs.\n2. Fry until golden.\n3. Serve hot.',
 'A kid-friendly snack!','Nuggets_20260106_165140.jpg','2026-01-06 00:50:00',1),

(21,'Nachos','Snack','Medium',5,10,2,'Tortilla chips\nCheese\nJalapeño',
 '1. Layer chips on baking sheet.\n2. Top with cheese and jalapeños.\n3. Bake until cheese melts.',
 'Great for sharing!','Nachos_20260106_165333.jpg','2026-01-06 00:55:00',1),

(22,'Sandwich','Snack','Hard',5,10,1,'Bread\nHam\nCheese',
 '1. Layer ingredients between bread slices.\n2. Press lightly.\n3. Serve as is or toast.',
 'Quick, versatile, portable snack!','Sandwich_20260106_165450.jpg','2026-01-06 01:00:00',1),

(23,'Pizza','Snack','Hard',5,15,2,'Dough\nTomato sauce\nCheese',
 '1. Spread sauce on dough.\n2. Add cheese.\n3. Bake until golden.',
 'A crowd-pleaser snack!','Pizza_20260106_165557.jpg','2026-01-06 01:05:00',1),

(24,'Cake','Dessert','Medium',5,15,4,'Flour\nSugar\nEggs',
 '1. Mix ingredients.\n2. Pour into pan.\n3. Bake at 350°F until done.',
 'Soft, sweet, perfect with tea!','Cake_20260106_172413.jpg','2026-01-06 01:10:00',1),

(25,'Brownies','Dessert','Hard',5,15,4,'Chocolate\nButter\nSugar',
 '1. Melt chocolate and butter.\n2. Mix in sugar.\n3. Bake at 350°F until set.',
 'Fudgy, rich, chocolatey delight!','Brownies_20260106_172643.jpg','2026-01-06 01:15:00',1),

(26,'Cookies','Dessert','Hard',5,15,4,'Flour\nButter\nSugar',
 '1. Mix ingredients.\n2. Scoop onto baking sheet.\n3. Bake until golden.',
 'Chewy, fun to make snack!','Cookies_20260106_172502.jpg','2026-01-06 01:20:00',1),

(27,'Ice Cream','Dessert','Easy',5,5,4,'Milk\nSugar\nVanilla',
 '1. Mix ingredients.\n2. Chill mixture.\n3. Freeze or churn.',
 'Cold, creamy, endless flavors!','Ice_Cream_20260106_172012.jpg','2026-01-06 01:25:00',1),

(28,'Pudding','Dessert','Easy',5,10,3,'Milk\nSugar\nCornstarch',
 '1. Mix cornstarch with milk.\n2. Heat remaining milk and sugar.\n3. Stir in cornstarch until thick.',
 'Silky, comforting, simple dessert!','Pudding_20260106_172110.jpg','2026-01-06 01:30:00',1),

(29,'Coffee','Drink','Easy',5,0,1,'Coffee\nWater\nSugar',
 '1. Brew coffee.\n2. Add sugar.\n3. Serve hot.',
 'Perfect morning boost!','Coffee_20260106_162905.jpg','2026-01-06 01:35:00',1),

(30,'Tea','Drink','Easy',5,0,1,'Tea leaves\nWater\nHoney',
 '1. Boil water and steep tea.\n2. Add honey.\n3. Serve warm.',
 'A calming, warm beverage!','Tea_20260106_163142.jpg','2026-01-06 01:40:00',1),

(31,'Lemonade','Drink','Medium',10,0,2,'Lemon\nWater\nSugar',
 '1. Squeeze lemons.\n2. Mix with water and sugar.\n3. Serve chilled.',
 'A perfect drink for summer!','Lemonade_20260106_163334.jpg','2026-01-06 01:45:00',1),

(32,'Smoothie','Drink','Hard',15,0,2,'Fruits\nYogurt\nHoney',
 '1. Blend fruits with yogurt.\n2. Sweeten with honey.\n3. Serve cold.',
 'A fruity, creamy, healthy snack!','Smoothie_20260106_163226.jpg','2026-01-06 01:50:00',1),

(33,'Latte','Drink','Hard',15,0,3,'Espresso\nMilk\nSugar',
 '1. Brew espresso.\n2. Add steamed milk.\n3. Sweeten if desired.',
 'A perfect creamy, warm drink!','Latte_20260106_163033.jpg','2026-01-06 01:55:00',1);
")
...
# Verify
# -------------------------
dbGetQuery(conn, "SELECT COUNT(*) AS users FROM users;")
dbGetQuery(conn, "SELECT COUNT(*) AS recipes FROM recipes;")
...
authenticate_user <- function(username, password) { 
  ...
  tryCatch({ 
    ...
    if (nrow(result) == 1) { 
      # Update last login with CURRENT_TIMESTAMP (SQLite compatible)
      update_query <- paste0( 
